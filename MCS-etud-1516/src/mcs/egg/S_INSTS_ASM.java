...
x_3.att_tds_asm=this.att_tds_asm;
  ...
  public void analyser () throws Exception {
    ...
    switch ( scanner.fenetre[0].code ) {
      case LEX_ASM.token_nl : // 234
        regle1 () ;
      break ;
      case LEX_ASM.token_info : // 240
        regle1 () ;
      break ;
      case LEX_ASM.token_load : // 218
        regle1 () ;
      break ;
      case LEX_ASM.token_loada : // 219
        regle1 () ;
      break ;
      case LEX_ASM.token_loadi : // 220
        regle1 () ;
      break ;
      case LEX_ASM.token_loadl : // 221
        regle1 () ;
      break ;
      case LEX_ASM.token_store : // 222
        regle1 () ;
      break ;
      case LEX_ASM.token_storei : // 223
        regle1 () ;
      break ;
      case LEX_ASM.token_call : // 224
        regle1 () ;
      break ;
      case LEX_ASM.token_calli : // 225
        regle1 () ;
      break ;
      case LEX_ASM.token_return : // 226
        regle1 () ;
      break ;
      case LEX_ASM.token_subr : // 227
        regle1 () ;
      break ;
      case LEX_ASM.token_ident : // 239
        regle1 () ;
      break ;
      case LEX_ASM.token_push : // 228
        regle1 () ;
      break ;
      case LEX_ASM.token_pop : // 229
        regle1 () ;
      break ;
      case LEX_ASM.token_jump : // 230
        regle1 () ;
      break ;
      case LEX_ASM.token_jumpi : // 231
        regle1 () ;
      break ;
      case LEX_ASM.token_jumpif : // 232
        regle1 () ;
      break ;
      case LEX_ASM.token_halt : // 233
        regle1 () ;
      break ;
      case LEX_ASM.token_acf : // 217
        regle2 () ;
      break ;
      default :
